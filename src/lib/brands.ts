...
// Produtos novos (Fase 2) — imagens editadas/estúdio processadas para src/assets
import bmwGBlackCarbon from "@/assets/bmw-g-black-carbon-1.jpg";
import bmwGBlueForged from "@/assets/bmw-g-blue-forged-1.jpg";
import bmwGBlackOrange from "@/assets/bmw-g-black-orange-1.jpg";
import audiR8Carbon from "@/assets/audi-r8-carbon-1.jpg";
import audiR8Blue from "@/assets/audi-r8-blue-1.jpg";
import mbAmgRedForged from "@/assets/mercedes-amg-red-forged-1.jpg";
import audiGreenForged from "@/assets/audi-green-forged-round-1.jpg";
import audiGreenCamo from "@/assets/audi-green-camo-1.jpg";
...
export type BrandModel = {
  ...
  /**
   * Atributos derivados da análise das imagens. São a FONTE ÚNICA DE VERDADE
   * da classificação: as categorias/filtros/páginas são calculados a partir
   * daqui (ver src/lib/attributes.ts e src/lib/collections.ts). Preencher só
   * em produtos finalizados e fotografados — os modelos-base (configuráveis)
   * ficam sem atributos e não aparecem nas páginas de filtro.
   */
...
export const BRANDS: Brand[] = [
  {
    ...
    models: [
      ...
      m({
        ...
        chassis: "F3x",
        description: "Volante base para Série 3 e Série 4 F-Series.",
        img: pelePerfurada,
        gallery: [pelePerfurada, alcantara, carbono, hero],
        compatibilities: ["320i", "320d", "330i", "335i", "340i"],
        specs: [
      ...
      m({
        slug: "f-series-carbon-red",
        name: "BMW F-Series Carbon Red Signature",
        chassis: "F3x / F8x",
        description: "Edição em carbono fosco com detalhe M Performance vermelho e patilhas em carbono. Compatível com M3 F80 e M4 F82.",
        longDescription:
        ...
        img: F80_GALLERY[0],
        gallery: F80_GALLERY,
        compatibilities: ["320i", "330i", "340i", "M3 F80", "M4 F82", "M2 F87"],
        specs: [
          { label: "Edição", value: "Carbon Red Signature" },
          { label: "Compatível", value: "F30 / F32 / F80 / F82" },
          { label: "Diâmetro", value: "370 mm" },
      ...
      m({
        slug: "f30-alcantara-signature",
        name: "BMW F30 Alcântara Signature",
        chassis: "F3x",
        description: "Edição em Alcântara premium com costura M tricolor para F30/F32.",
        longDescription:
          "Volante F30 revestido em Alcântara premium, com marca 12h e costura tricolor M. Peça única com acabamento artesanal.",
        img: bmwF30Alc.url,
        gallery: [bmwF30Alc.url],
        compatibilities: ["320i", "320d", "330i", "335i", "340i"],
        specs: [
          { label: "Edição", value: "Alcântara Signature" },
          { label: "Compatível", value: "F30 / F31 / F32 / F33 / F36" },
          { label: "Diâmetro", value: "370 mm" },
      ...
      m({
        slug: "f30-mperf-blue-signature",
        name: "BMW F30 M Performance Blue Signature",
        chassis: "F3x",
        description: "Edição M Performance com detalhe azul e patilhas em carbono para F30/F32.",
        longDescription:
          "Volante F30 M Performance com aros em pele perfurada, detalhe central em azul M Performance e patilhas de mudança em carbono. Costura tricolor M.",
        img: bmwF30Blue.url,
        gallery: [bmwF30Blue.url],
        compatibilities: ["320i", "330i", "335i", "340i", "M2 F87"],
        specs: [
          { label: "Edição", value: "M Performance Blue" },
          { label: "Compatível", value: "F30 / F31 / F32 / F33" },
          { label: "Diâmetro", value: "370 mm" },
      ...
      m({
        ...
        name: "BMW G20 / G21",
        chassis: "G2x",
        description: "Volante base para Série 3 actual (2019+).",
        img: alcantara,
        gallery: [alcantara, carbono, oemPlus, hero],
        compatibilities: ["320i", "320d", "330i", "330e", "340i"],
        specs: [
      ...
      m({
        slug: "g-series-forged-magenta",
        name: "BMW G-Series Forged Magenta Signature",
        chassis: "G2x / G8x",
        description: "Edição exclusiva em carbono forjado com flocos magenta e costura racing amarela. Compatível com M3 G80 e M4 G82.",
        longDescription:
        ...
        img: G80_GALLERY[0],
        gallery: G80_GALLERY,
        compatibilities: ["330i", "340i", "M3 G80", "M3 Touring G81", "M4 G82"],
        specs: [
          { label: "Edição", value: "Forged Magenta Signature" },
          { label: "Compatível", value: "G20 / G80 / G82" },
          { label: "Diâmetro", value: "370 mm" },
        ...
        attributes: {
          formato: "flat-bottom",
          linha: "desportivo",
          materiais: ["carbono-forjado", "carbono-colorido", "alcantara"],
          costuras: ["amarela"],
          features: ["led-shift", "patilhas", "patilhas-carbono", "botoes-multifuncoes", "faixa-12h"],
        },
        sku: "RL-BMW-GSERIES-FM",
        price: { amount: 1199, currency: "EUR" },
        status: "Disponível",
      }),
      m({
        slug: "g20-blue-carbon-signature",
        name: "BMW G20 Blue Carbon Signature",
        chassis: "G2x",
      ...
      m({
        slug: "g-series-black-carbon",
        name: "BMW M G-Series Black Carbon Signature",
        chassis: "G2x / G8x",
        description: "Volante M flat bottom em carbono brilhante e pele perfurada, com costura tricolor M.",
        longDescription:
          "Volante BMW M G-Series flat bottom com aro superior em fibra de carbono brilhante, zonas de pegada em pele perfurada e marca 12h com costura tricolor M. Acabamento de assinatura REDLINE.",
        img: bmwGBlackCarbon,
        gallery: [bmwGBlackCarbon],
        compatibilities: ["320i", "330i", "M340i", "M3 G80", "M4 G82"],
        specs: [
          { label: "Edição", value: "Black Carbon Signature" },
          { label: "Formato", value: "Flat Bottom" },
          { label: "Material", value: "Carbono Brilhante + Pele Perfurada" },
          { label: "Costura", value: "Tricolor M" },
        ],
        sku: "RL-BMW-G-BLKCB",
        price: { amount: 949, currency: "EUR" },
      ...
      m({
        slug: "g-series-blue-forged",
        name: "BMW M G-Series Blue Forged Signature",
        chassis: "G2x / G8x",
        description: "Edição em carbono forjado azul com patilhas e costura tricolor M.",
        longDescription:
          "Volante BMW M G-Series flat bottom em carbono forjado com tonalidade azul, spoke central azul, aros em pele perfurada, patilhas de mudança e marca 12h com costura tricolor M. Peça de assinatura REDLINE.",
        img: bmwGBlueForged,
        gallery: [bmwGBlueForged],
        compatibilities: ["330i", "M340i", "M3 G80", "M3 Touring G81", "M4 G82"],
        specs: [
          { label: "Edição", value: "Blue Forged Signature" },
          { label: "Formato", value: "Flat Bottom" },
          { label: "Material", value: "Carbono Forjado Azul + Pele Perfurada" },
      ...
      m({
        slug: "g-series-black-orange",
        name: "BMW M G-Series Orange Marker Signature",
        chassis: "G2x / G8x",
        description: "Volante M flat bottom em carbono e pele perfurada com marca 12h laranja.",
        longDescription:
          "Volante BMW M G-Series flat bottom em fibra de carbono e pele perfurada, com marca 12h em laranja e costura tricolor M no spoke inferior. Assinatura REDLINE.",
        img: bmwGBlackOrange,
        gallery: [bmwGBlackOrange],
        compatibilities: ["320i", "330i", "M340i", "M3 G80", "M4 G82"],
        specs: [
          { label: "Edição", value: "Orange Marker Signature" },
          { label: "Formato", value: "Flat Bottom" },
          { label: "Material", value: "Carbono + Pele Perfurada" },
          { label: "Costura", value: "Tricolor M" },
        ],
  ...
  },
  {
    ...
    models: [
      ...
      m({
        ...
        description: "Classe C (2014–2021) — base personalizável.",
        img: pelePerfurada,
        gallery: [pelePerfurada, carbono, alcantara, hero],
      ...
      m({
        slug: "w205-amg-yellow-signature",
        name: "Mercedes W205 AMG Yellow Signature",
        chassis: "W205",
        description: "Edição AMG com marca 12h amarela e patilhas em alumínio para W205.",
        longDescription:
          "Volante W205 AMG com aros em pele perfurada, banda superior em Alcântara, marca 12h em amarelo racing e patilhas em alumínio anodizado. Costuras contrastantes.",
        img: mbW205Yellow.url,
        gallery: [mbW205Yellow.url],
        compatibilities: ["C200", "C300", "C43 AMG", "C63 AMG W205"],
        specs: [
      ...
      m({
        ...
        name: "Mercedes W213",
        chassis: "W213 / S213",
        description: "Classe E (2016+) — base personalizável.",
        img: oemPlus,
        gallery: [oemPlus, pelePerfurada, alcantara, hero],
      ...
      m({
        slug: "w213-amg-edition1-signature",
        name: "Mercedes W213 AMG Edition 1 Signature",
        chassis: "W213",
        description: "Edição 1 AMG com Alcântara e detalhes amarelos exclusivos.",
        longDescription:
          "Volante W213 inspirado na AMG Edition 1: aros em Alcântara, marca 12h em amarelo, costuras contrastantes e placa central AMG.",
        img: mbW213Edition1.url,
        gallery: [mbW213Edition1.url],
        compatibilities: ["E43 AMG", "E53 AMG", "E63 AMG S"],
        specs: [
      ...
      m({
        slug: "w213-amg-red-signature",
        name: "Mercedes W213 AMG Red Signature",
        chassis: "W213",
        description: "Edição AMG com costuras vermelhas e Alcântara premium.",
        longDescription:
          "Volante W213 AMG com aros em pele perfurada, banda em Alcântara e costuras vermelhas contrastantes.",
        img: mbW213Red.url,
        gallery: [mbW213Red.url],
        compatibilities: ["E300", "E43 AMG", "E63 AMG S"],
        specs: [
      ...
      m({
        slug: "w213-amg-forged-red-signature",
        name: "Mercedes W213 AMG Forged Red Signature",
        chassis: "W213",
        description: "Edição top com carbono forjado e detalhes vermelhos para W213.",
        longDescription:
          "Volante W213 AMG top-of-line com spokes em carbono forjado, banda superior em Alcântara vermelho, marca 12h vermelha e patilhas em carbono. Peça de assinatura REDLINE.",
        img: mbW213Forged.url,
        gallery: [mbW213Forged.url],
        compatibilities: ["E63 AMG", "E63 AMG S"],
        specs: [
          { label: "Edição", value: "AMG Forged Red Signature" },
          { label: "Compatível", value: "W213 / S213" },
          { label: "Material", value: "Carbono Forjado + Alcântara" },
          { label: "Detalhe", value: "Vermelho" },
          { label: "Patilhas", value: "Carbono" },
        ],
        attributes: {
          formato: "flat-bottom",
      ...
      m({
        slug: "amg-red-forged-signature",
        name: "Mercedes-AMG Red Forged Signature",
        chassis: "AMG",
  ...
  },
  {
    ...
    models: [
      ...
      m({
        ...
        name: "Audi 8Y",
        chassis: "8Y",
        description: "A3 / S3 / RS3 actual (2020+) — base personalizável.",
        img: carbono,
        gallery: [carbono, pelePerfurada, alcantara, hero],
      ...
      m({
        slug: "8y-carbon-signature",
        name: "Audi 8Y Carbon Signature",
        chassis: "8Y",
        description: "Edição em carbono com Alcântara para A3/S3/RS3 8Y.",
        longDescription:
          "Volante 8Y com aros em Alcântara, spokes em carbono brilhante, marca 12h e costura contrastante. Assinatura REDLINE.",
        img: audi8yCarbon.url,
        gallery: [audi8yCarbon.url],
        compatibilities: ["A3 8Y", "S3 8Y", "RS3 8Y"],
        specs: [
      ...
      m({
        ...
        name: "Audi B8 / B8.5",
        chassis: "B8",
        description: "A4 / S4 / RS4 / A5 / S5 / RS5 (2007–2016) — base personalizável.",
        img: pelePerfurada,
        gallery: [pelePerfurada, oemPlus, alcantara, hero],
      ...
      m({
        slug: "b8-rs-blue-signature",
        name: "Audi B8 RS Blue Signature",
        chassis: "B8",
        description: "Edição RS em Alcântara com marca 12h azul para B8/B8.5.",
        longDescription:
          "Volante B8 RS com aros em Alcântara, marca 12h em azul RS e costuras contrastantes. Peça de assinatura REDLINE.",
        img: audiB8Blue.url,
        gallery: [audiB8Blue.url],
        compatibilities: ["S4 B8", "RS4 B8", "S5 B8", "RS5 B8"],
        specs: [
      ...
      m({
        slug: "green-forged-signature",
        name: "Audi Green Forged Signature",
        chassis: "Gama S / RS",
        description: "Volante round em carbono forjado verde, pele perfurada e costuras verdes.",
        longDescription:
          "Volante Audi de formato round com detalhes em carbono forjado verde, zonas de pegada em pele perfurada, costuras verdes contrastantes, arranque vermelho e botões multifunções. Assinatura REDLINE.",
        img: audiGreenForged,
        gallery: [audiGreenForged],
        compatibilities: ["A4 B9", "S4 B9", "RS4 B9", "A5 B9", "RS5 B9"],
        specs: [
          { label: "Edição", value: "Green Forged Signature" },
          { label: "Formato", value: "Round" },
          { label: "Material", value: "Carbono Forjado Verde + Pele Perfurada" },
          { label: "Costura", value: "Verde" },
        ],
        sku: "RL-AUDI-GRNF",
        price: { amount: 999, currency: "EUR" },
        status: "Sob Encomenda",
      ...
      m({
        slug: "green-camo-signature",
        name: "Audi Green Camo Forged Signature",
        chassis: "Gama S / RS",
        description: "Volante flat bottom em carbono forjado verde camuflado com costuras verdes.",
        longDescription:
          "Volante Audi flat bottom em carbono forjado com padrão verde camuflado, zonas de pegada em pele perfurada, costuras verdes e botões multifunções. Peça de assinatura REDLINE.",
        img: audiGreenCamo,
        gallery: [audiGreenCamo],
        compatibilities: ["A6 C8", "S6 C8", "RS6 C8", "RS7 C8"],
        specs: [
          { label: "Edição", value: "Green Camo Signature" },
          { label: "Formato", value: "Flat Bottom" },
          { label: "Material", value: "Carbono Forjado Verde + Pele Perfurada" },
          { label: "Costura", value: "Verde" },
        ],
      ...
      m({
        slug: "rs-suede-signature",
        name: "Audi RS Suede Signature",
        chassis: "Gama RS",
        ...
        specs: [
          { label: "Edição", value: "Suede Signature" },
          { label: "Formato", value: "Flat Bottom" },
  ...
  },
  {
    ...
    models: [
      ...
      m({
        slug: "forged-carbon-signature",
        name: "Volkswagen Forged Carbon Signature",
        chassis: "MQB",
        description: "Volante GTI/R flat bottom em carbono forjado e Alcantara, com patilhas.",
        longDescription:
          "Volante Volkswagen flat bottom com spokes em carbono forjado, zonas de pegada em Alcantara, anel central azul e patilhas de mudança. Peça de assinatura REDLINE para a gama GTI e R.",
        img: vwForged,
        gallery: [vwForged],
        compatibilities: ["Golf 7 GTI", "Golf 7 R", "Golf 8 GTI", "Golf 8 R"],
        specs: [
  ...
  },
  {
    ...
    models: [
      m({
        ...
        name: "Porsche 991",
        chassis: "991.1 / 991.2",
        description: "911 (2012–2019) — base personalizável.",
        img: alcantara,
        gallery: [alcantara, carbono, wheel, hero],
