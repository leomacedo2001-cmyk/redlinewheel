  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo correu mal. Tenta novamente ou volta à home.
        </p>
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a
            href="/"
            className="rounded-sm border border-input px-4 py-2 text-sm font-medium hover:bg-accent"
          >
            Home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "REDLINE Performance — Volantes Premium Personalizados" },
      {
        name: "description",
        content:
          "Volantes desportivos e acessórios premium para BMW, Audi, Porsche, Mercedes e mais. Personalização automóvel de alta qualidade.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/090adf9e-ebb9-437d-9e1a-8cb88b77e9a2",
      },
      {
        name: "twitter:image",
        content:
