...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "APEX Automotive" },
      { property: "og:title", content: "APEX Automotive — Volantes Premium Personalizados" },
      { property: "og:description", content: "Volantes desportivos e acessórios premium para entusiastas automóveis." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "APEX Automotive" },
