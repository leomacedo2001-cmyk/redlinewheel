...
export const Route = createFileRoute("/paddleshift")({
  head: () => ({
    meta: [
      { title: "PaddleShift — Patilhas de Mudança | REDLINE Performance" },
      {
        name: "description",
        content:
          "Patilhas de mudança REDLINE em alumínio e fibra de carbono real, com encaixe por clipe sobre a patilha OEM.",
      },
      { property: "og:title", content: "PaddleShift — Patilhas de Mudança | REDLINE Performance" },
      { property: "og:url", content: `${SITE_URL}/paddleshift` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/paddleshift` }],
  }),
  component: PaddleShiftPage,
});

function PaddleShiftPage() {
  return (
    <div className="container-premium py-16 md:py-24">
      <header className="mb-12 border-b border-border/60 pb-8">
        <div className="text-xs uppercase tracking-[0.3em] text-primary mb-3">PaddleShift</div>
        <h1 className="text-5xl md:text-6xl font-bold">Patilhas de mudança REDLINE.</h1>
        <p className="text-muted-foreground mt-4 max-w-2xl">
          Patilhas de mudança de assinatura REDLINE em alumínio e fibra de carbono real, com encaixe por clipe
          sobre a patilha OEM — sem furar nem modificar o volante original.
        </p>
      </header>
